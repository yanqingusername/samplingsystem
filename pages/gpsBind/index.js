            ...
            for(let i =0;i< that.data.numberList.length;i++){
              ...
              if(item.line_content!= null && item.line_content != ""){
                if(item.line_content.indexOf(":") >=0 || item.line_content.indexOf("：")>=0){
                  ...
                  if(item.line_content != undefined && typeof(item.line_content) != 'undefined'){
                ...
                if(item.line_content!= null && item.line_content != "" && item.line_content != undefined && typeof(item.line_content) != 'undefined'){
